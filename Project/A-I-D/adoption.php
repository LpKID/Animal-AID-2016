...
$sql="SELECT * FROM animals INNER JOIN donationtypes ON animals.do_typeId=donationtypes.do_typeId WHERE donationtypes.do_typeId=3 ORDER BY animal_id  LIMIT 30 ";
$sql2="SELECT * FROM animals INNER JOIN donationtypes ON animals.do_typeId=donationtypes.do_typeId  WHERE donationtypes.do_typeId=3 and statusDonation='1' ORDER BY animal_id  ";
